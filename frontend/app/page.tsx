    ...
    <main className="min-h-screen bg-black text-white p-6">
      ...
      <div className="mt-6 max-w-3xl space-y-3">
        <div className="rounded border border-gray-700 p-4">
          ...
          <pre className="mt-3 rounded bg-gray-100 p-3 text-black">
            {JSON.stringify(health, null, 2)}
          </pre>
        </div>

        <p className="text-sm text-gray-400">
          Tip: the backend root <code>http://localhost:4000/</code> shows “Cannot GET /” by design. Use{' '}
          <code>/health</code> or the UI above.
        </p>
      </div>
    </main>
  );
